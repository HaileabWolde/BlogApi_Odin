...
function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#faf9f7]">
      ...
      {/* Hero section */}
      <div className="flex flex-col items-center text-center gap-4 p-8 border-b-2 border-[#e5e3df]">
        <p className="text-md font-serif text-[#666]">
          A Blog FOR ETHIOPIAN DEVELOPERS
        </p>
        ...
        <p className="text-sm font-serif text-[#666]">
          Practical articles on Node.js, React, PostgreSQL and everything in
          between.
          <br />
      ...
      <main className="max-w-4xl mx-auto py-8 flex flex-col">
        ...
        {!loading && (!allPost || allPost.length === 0) && (
          <h1 className="text-3xl font-bold font-serif text-[#666] text-center py-16">
            No Posts Yet
          </h1>
        )}
        ...
        {!loading &&
          ...
          allPost.length > 0 &&
          allPost.map((post) => {
            const { content, coverImageUrl, createdAt, title, tags, author } =
              post
            return (
              <Link
                to={`/post/${post.id}`}
              ...
              >
                <div className="flex flex-col gap-4 justify-center">
                  ...
                  <div className="flex gap-4 items-center">
                    <div className="w-8 h-8 rounded-full bg-violet-600 flex items-center justify-center text-white text-lg font-serif">
